  ...
  <body>
    ...
    <div class="container-fluid">
      <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container">
          <a class="navbar-brand" href="../main-page.php" class="logo"><i class="fas fa-heartbeat"></i>
            <b>HealthCare</b></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 m-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="../patient/index.php" target="_blank">Patient Panel</a></li>
                  <li><a class="dropdown-item" href="../doctors/index.php" target="_blank">Doctor Panel</a></li>
