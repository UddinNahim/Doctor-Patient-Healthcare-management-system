...
if (isset($_POST["register"])) {
    ...
    $check_query = mysqli_query($connect, "SELECT * FROM doctor_login where email = '$email'");
    ...
    if (!empty($firstName) && !empty($lastName) && !empty($phoneNo) && !empty($email) && !empty($password)) {
        if ($rowCount > 0) {
            ...
            $result = mysqli_query($connect, "INSERT INTO doctor_login (firstName, lastName, phoneNo, email, password, status) VALUES ('$firstName', '$lastName', '$phoneNo', '$email', '$password_hash', 0)");
            ...
            if ($result) {
                ...
                <br><br>
                <p>With regards,</p>
                <b>Doctor Patient Health Care System</b>";
...
<main class="login-form">
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center">Doctor Register</div>
                    <div class="card-body">
                        <form action="#" method="POST" name="register">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                <input type="tel" class="form-control" name="phoneNo" maxlength="11" placeholder="Contact Number" required> 
                                </div>
                            </div>
