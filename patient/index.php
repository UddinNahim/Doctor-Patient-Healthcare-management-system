<?php
    ...
    if(isset($_POST["login"])){
        ...
        $password = hash('sha256', '2123293dsj2hu2nikhiljdsd' . $passw);

        $sql = "SELECT * FROM patient WHERE loginid='" .$email . "' and password = '". $password."'";
...
<nav class="navbar navbar-expand-lg navbar-light navbar-laravel">
    <div class="container">
        <a class="navbar-brand" href="#">Patient Login Form</a>
...
<main class="login-form">
    <div class="container">
        ...
        <div class="img-wrapper">
                    <img src="../image/log_img.jpg" alt="" class="img-fluid">
                </div>
        </div>
            <div class="col-md-4">
                <div class="card">
