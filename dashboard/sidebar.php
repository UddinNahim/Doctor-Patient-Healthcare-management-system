    ...
    <?php if(($_SESSION['user'] == 'admin') || ($_SESSION['user'] == 'doctor')) { ?>
        <li class="">
            <a href="view-pending-appointment.php">
                <span class="pcoded-mtext"> View Patient Appointments</span>
            </a>
        </li>
        <!-- <li class="">
    ...
    <?php } ?>
        <li class="">
            <a href="view-patient.php">
                <span class="pcoded-mtext">View User Records</span>
            </a>
        </li>
    </ul>
</li>
    ...
    <ul class="pcoded-submenu">
        ...
        <li class="">
            <a href="prescription.php">
                <span class="pcoded-mtext">Add Prescription</span>
            </a>
        </li>

        <li class="">
            <a href="view-prescription.php">
                <span class="pcoded-mtext">View Prescription</span>
            </a>
        </li>
        ...
        <li class="">
            <a href="medicine1.php">
                <span class="pcoded-mtext">Add Timing</span>
            </a>
        </li>

        <li class="">
            <a href="view-medicine1.php">
                <span class="pcoded-mtext">View Timing</span>
            </a>
        </li>
    </ul>
</li>
