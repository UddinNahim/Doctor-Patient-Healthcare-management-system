...
<?php
            ...
            //echo "<script>window.location='view-prescription.php';</script>";
    }
}
?>
<?php
...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    <h3 class="popup__content__title">
      ...
      <p>
        <a href="view-prescription.php?id=<?php echo $_GET['delid']; ?>"
          class="button button--success" data-for="js_success-popup">Yes</a>
        <a href="view-prescription.php" class="button button--error" data-for="js_success-popup">No</a>
      </p>
  </div>
</div>
<?php } ?>
...
?>
                  ...
                  <tbody>
                    <?php
    $sql =mysqli_query($conn, "SELECT * FROM prescriptions ORDER BY id DESC");
while($rs = mysqli_fetch_array($sql)) {
    ...
    if(isset($_SESSION['adminid'])) {
        echo "<td>&nbsp;
            <a href='prescription.php?editid=$rs[id]' class='btn btn-primary'>Edit</a> 
            <a href='view-prescription.php?delid=$rs[id]' class='btn btn-danger'>Delete</a> </td>";
    }
    echo "</tr>";
}
?>
