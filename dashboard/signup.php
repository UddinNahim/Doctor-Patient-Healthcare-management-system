...
<style>
   body {
    background-image: linear-gradient( 180deg, #dbe8ff 78.25%, rgba(219, 232, 255, 0) 100% );
  }
</style>
</head>
...
<h1 style="color: #6c56f5; font-weight:700; text-align:center;">DASHBOARD PANEL</h1>
<div class="container-fluid">
<div class="row">
<div class="col-sm-12">
...
<h3 class="text-center txt-primary">Dashboard Signup</h3>
</div>
</div>
<div class="row">
<div class="col-sm-6">
