...
if(isset($_POST['btn_submit']))
{
    ...
    {
        $sql ="UPDATE medicine1 SET medicinename='$_POST[medicinename]',medicinecost='$_POST[medicinecost]',description='$_POST[description]',status='$_POST[status]' WHERE medicineid='$_GET[editid]'";
 ...
 ?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>Timeing Record Updated Successfully</p>
                <p>
                 <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
                 <?php echo "<script>setTimeout(\"location.href = 'view-medicine1.php';\",1500);</script>"; ?>
                </p>
              </div>
            </div>
 <?php
    ...
    {
        $sql ="INSERT INTO medicine1(medicinename,medicinecost,description,status) values('$_POST[medicinename]','$_POST[medicinecost]','$_POST[description]','$_POST[status]')";
        if($qsql = mysqli_query($conn,$sql))
        {
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>Timeing Record Inserted Successfully</p>
                <p>
                 <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
                 <?php echo "<script>setTimeout(\"location.href = 'view-medicine1.php';\",1500);</script>"; ?>
                </p>
...
if(isset($_GET['editid']))
{
    $sql="SELECT * FROM medicine1 WHERE medicineid='$_GET[editid]' ";
...
<li class="breadcrumb-item"><a>Timeing </a>
</li>
<li class="breadcrumb-item"><a href="#">Add Time</a>
</li>
</ul>
</div>
</div>
...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        <label class="col-sm-2 col-form-label">Timing  Name</label>
        <div class="col-sm-8">
    ...
    <div class="form-group row">
        <label class="col-sm-2 col-form-label">Timing  Does </label>
        <div class="col-sm-8">
